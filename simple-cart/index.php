            ...
            <div class="card-body">
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mt-2 text-center">
                        <button class="btn btn-success fw-bold" name="order"><i class="bi bi-cart-plus"> </i> Pesan</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-md-8 mb-2">
        <div class="card bg-light shadow">
            ...
            <div class="card-body">
                ...
                if (!empty($carts)) { ?>
                    <a 
                        href="<?= url('index.php?action=empty_cart') ?>" 
                ...
                <form action="" method="POST">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a 
                                            href="<?= url('index.php?action=delete_cart&product_id=' . $cart['id']) ?>"
                    ...
                    <?php if (!empty($carts)) { ?>
                        <button class="btn btn-warning float-end text-white fw-bold" type="submit" name="update"><i class="bi bi-pencil"> </i>Update Keranjang</button>
                    <?php } ?>
                </form>
            </div>
            <?php if (!empty($cart)) { ?>
